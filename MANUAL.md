# Manual Setup Steps for Minions Content-plans
...
Go to **GitHub → mxn2020/minions-content-plans → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-content-plans` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-content-plans-web`
- **GitHub repo**: `mxn2020/minions-content-plans`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `content-plans.minions.wtf`

### Documentation
- **Netlify site name**: `minions-content-plans-docs`
- **GitHub repo**: `mxn2020/minions-content-plans`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `content-plans.minions.help`

### Blog
- **Netlify site name**: `minions-content-plans-blog`
- **GitHub repo**: `mxn2020/minions-content-plans`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `content-plans.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `content-plans.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `content-plans.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `content-plans.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-content-plans/sdk`](https://www.npmjs.com/package/@minions-content-plans/sdk)
- CLI: [`@minions-content-plans/cli`](https://www.npmjs.com/package/@minions-content-plans/cli)
...
Your package: [`minions-content-plans`](https://pypi.org/project/minions-content-plans/)
...
| Item | Value |
|------|-------|
| Project | `minions-content-plans` |
| SDK (npm) | `@minions-content-plans/sdk` |
| CLI (npm) | `@minions-content-plans/cli` |
| Python (PyPI) | `minions-content-plans` |
| GitHub | `github.com/mxn2020/minions-content-plans` |
| Docs domain | `content-plans.minions.help` |
| Blog domain | `content-plans.minions.blog` |
| App domain | `content-plans.minions.wtf` |
