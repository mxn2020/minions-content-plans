# Contributing to Minions Content-plans

Thank you for your interest in contributing to Minions Content-plans!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-content-plans.git`
