...
/**
 * @minions-content-plans/cli — CLI for Minions Content-plans
 *
...
import { customTypes } from '@minions-content-plans/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Content-plans'));
        console.log(chalk.dim('Content calendars, themes, and posting schedules per account group'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-content-plans/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-content-plans/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-content-plans')}`);
